...
class ProductStore: ObservableObject {
    ...
    func getExpiringProducts() -> [Product] {
        return products.filter { $0.isExpiringSoon && $0.isActive }
    }
    
    func getExpiredProducts() -> [Product] {
        return products.filter { $0.isExpired && $0.isActive }
    }
    ...
    private func addSampleProducts() {
        ...
        let detailedProducts: [(
            ...
            (
                "Тональный крем True Match", "L'Oréal", .foundation, -60, 15, "L'Oréal True Match Foundation", "Любимый оттенок W3",
            ...
            (
                "Помада Ruby Woo", "MAC", .lipstick, -30, -5, "MAC Ruby Woo Lipstick", "Классический красный",
            ...
            (
                "Тушь для ресниц Lash Sensational", "Maybelline", .mascara, -90, 7, "Maybelline Lash Sensational Mascara", "Водостойкая формула",
            ...
            (
                "Увлажняющий крем", "CeraVe", .moisturizer, -14, 180, "CeraVe Moisturizing Cream", "Для сухой кожи",
            ...
            (
                "Тени для век Naked", "Urban Decay", .eyeshadow, -180, 365, "Urban Decay Naked Eyeshadow Palette", "Палетка нейтральных оттенков",
            ...
            (
                "Консилер Fit Me", "Maybelline", .concealer, -45, 60, "Maybelline Fit Me Concealer", "Светлый оттенок",
            ...
            (
                "Румяна Orgasm", "NARS", .blush, -120, 300, "NARS Orgasm Blush", "Персиковый с золотым шиммером",
            ...
            (
                "Бронзер Chocolate Soleil", "Too Faced", .bronzer, -90, 400, "Too Faced Chocolate Soleil Bronzer", "Матовый финиш",
            ...
            (
                "Хайлайтер Champagne Pop", "Becca", .highlighter, -60, 450, "Becca Champagne Pop Highlighter", "Сияющий золотистый",
            ...
            (
                "Подводка для глаз", "Stila", .eyeliner, -75, 20, "Stila Stay All Day Eyeliner", "Стойкая жидкая подводка",
            ...
            (
                "Блеск для губ", "Fenty Beauty", .lipGloss, -30, 100, "Fenty Beauty Gloss Bomb", "Прозрачный с блестками",
            ...
            (
                "Праймер для лица", "Benefit", .primer, -50, 150, "Benefit Porefessional Primer", "Сужает поры",
            ...
            (
                "Очищающий гель", "La Roche-Posay", .cleanser, -20, 200, "La Roche-Posay Effaclar Cleanser", "Для чувствительной кожи",
            ...
            (
                "Сыворотка с витамином C", "The Ordinary", .serum, -40, 90, "The Ordinary Vitamin C Serum", "Осветляющая",
            ...
            (
                "Солнцезащитный крем SPF 50", "Bioré", .sunscreen, -10, 250, "Bioré UV Aqua Rich Sunscreen", "Невидимый финиш",
            ...
            (
                "Пудра компактная Fit Me", "Maybelline", .powder, -35, 120, "Maybelline Fit Me Powder", "Матирующая",
            ...
            (
                "Тональная основа Studio Fix", "MAC", .foundation, -70, 25, "MAC Studio Fix Foundation", "Средний тон",
        ...
        for (name, brand, category, purchaseOffset, expiryOffset, imageName, notes, ingredients, howToUse, benefits, warnings) in detailedProducts {
            ...
            var product = Product(
                ...
                expiryDate: calendar.date(byAdding: .day, value: expiryOffset, to: today),
                barcode: nil,
                imageData: imageData,
                notes: notes
            )
