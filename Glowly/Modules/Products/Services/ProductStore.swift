...
class ProductStore: ObservableObject {
    ...
    private func updateNotifications() {
        // Daily and evening routine reminders are set up once in setupNotifications()
        // No expiry notifications needed
    }
    ...
    private func addSampleProducts() {
        ...
        let detailedProducts: [(
            ...
            daysOffset: Int, imageName: String, notes: String,
            ingredients: String, howToUse: String, benefits: [String], warnings: [String]
        )] = [
            (
                "Тональный крем True Match", "L'Oréal", .foundation, .face, -60, "L'Oréal True Match Foundation", "Любимый оттенок W3",
            ...
            (
                "Помада Ruby Woo", "MAC", .lipstick, .lips, -30, "MAC Ruby Woo Lipstick", "Классический красный",
            ...
            (
                "Тушь для ресниц Lash Sensational", "Maybelline", .mascara, .eyes, -90, "Maybelline Lash Sensational Mascara", "Водостойкая формула",
            ...
            (
                "Увлажняющий крем", "CeraVe", .moisturizer, .face, -14, "CeraVe Moisturizing Cream", "Для сухой кожи",
            ...
            (
                "Тени для век Naked", "Urban Decay", .eyeshadow, .eyes, -180, "Urban Decay Naked Eyeshadow Palette", "Палетка нейтральных оттенков",
            ...
            (
                "Консилер Fit Me", "Maybelline", .concealer, .face, -45, "Maybelline Fit Me Concealer", "Светлый оттенок",
            ...
            (
                "Румяна Orgasm", "NARS", .blush, .cheeks, -120, "NARS Orgasm Blush", "Персиковый с золотым шиммером",
            ...
            (
                "Бронзер Chocolate Soleil", "Too Faced", .bronzer, .face, -90, "Too Faced Chocolate Soleil Bronzer", "Матовый финиш",
            ...
            (
                "Хайлайтер Champagne Pop", "Becca", .highlighter, .face, -60, "Becca Champagne Pop Highlighter", "Сияющий золотистый",
            ...
            (
                "Подводка для глаз", "Stila", .eyeliner, .eyes, -75, "Stila Stay All Day Eyeliner", "Стойкая жидкая подводка",
            ...
            (
                "Блеск для губ", "Fenty Beauty", .lipGloss, .lips, -30, "Fenty Beauty Gloss Bomb", "Прозрачный с блестками",
            ...
            (
                "Праймер для лица", "Benefit", .primer, .face, -50, "Benefit Porefessional Primer", "Сужает поры",
            ...
            (
                "Очищающий гель", "La Roche-Posay", .cleanser, .face, -20, "La Roche-Posay Effaclar Cleanser", "Для чувствительной кожи",
            ...
            (
                "Сыворотка с витамином C", "The Ordinary", .serum, .face, -40, "The Ordinary Vitamin C Serum", "Осветляющая",
            ...
            (
                "Солнцезащитный крем SPF 50", "Bioré", .sunscreen, .face, -10, "Bioré UV Aqua Rich Sunscreen", "Невидимый финиш",
            ...
            (
                "Пудра компактная Fit Me", "Maybelline", .powder, .face, -35, "Maybelline Fit Me Powder", "Матирующая",
            ...
            (
                "Тональная основа Studio Fix", "MAC", .foundation, .face, -70, "MAC Studio Fix Foundation", "Средний тон",
        ...
        for (name, brand, category, applicationZone, purchaseOffset, imageName, notes, ingredients, howToUse, benefits, warnings) in detailedProducts {
